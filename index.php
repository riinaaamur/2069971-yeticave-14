...
$user_name = 'Карина'; // укажите здесь ваше имя
?>
<!DOCTYPE html>
<html lang="ru">
<head>
        ...
        <section class="lots">
            ...
            <ul class="lots__list">
                ...
                <li class="lots__item lot">
                    ...
                    <div class="lot__info">
                        <span class="lot__category"><?=$ads1['category'];?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$ads1['title'];?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=$ads1['price'];?><b class="rub">р</b></span>
                            </div>
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="img/lot-2.jpg" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?=$ads2['category'];?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$ads2['title'];?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=$ads2['price'];?><b class="rub">р</b></span>
                            </div>
                            <div class="lot__timer timer">
                                12:23
                            </div>
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="img/lot-3.jpg" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?=$ads3['category'];?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$ads3['title'];?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=$ads3['price'];?><b class="rub">р</b></span>
                            </div>
                            <div class="lot__timer timer">
                                12:23
                            </div>
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="img/lot-4.jpg" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?=$ads4['category'];?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$ads4['title'];?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=$ads4['price'];?><b class="rub">р</b></span>
                            </div>
                            <div class="lot__timer timer">
                                12:23
                            </div>
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="img/lot-5.jpg" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?=$ads5['category'];?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$ads5['title'];?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=$ads5['price'];?><b class="rub">р</b></span>
                            </div>
                            <div class="lot__timer timer">
                                12:23
                            </div>
                ...
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="img/lot-6.jpg" width="350" height="260" alt="">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?=$ads6['category'];?></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$ads6['title'];?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?=$ads6['price'];?><b class="rub">р</b></span>
                            </div>
                            <div class="lot__timer timer">
                                12:23
                            </div>
